...
<html lang="en">
    ...
    <head>
        ...
        <title>Rice Fertilization</title>
            ...
            <div class="row">
                <div class="box">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>Rice Fertilization</strong>
                    </h2>
                    <hr>
                    <img src="images/vlcsnap-2015-03-23-01h14m43s183.png" height=400 weidth=600 >

                    <div class="container-fluid" style="margin-top:1%">        
                        <form method="post" action="RiceFertilization" class="form-inline">
