...
<sql:query dataSource="${snapshot}" var="wheat">
    SELECT * FROM wheat_sowing_table where id=1;
</sql:query>
            ...
            <div class="row">
                <div class="box">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>Wheat Harvesting</strong>
                    </h2>
                    <hr>
                    <img src="images/wheat-harvest.jpg" height=400 weidth=600 >

                    <div class="container-fluid" style="margin-top:1%">        
                        <form method="post" action="WheatHarvesting" class="form-inline">
                            ...
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <label for="quantity" >Cycle</label>
                                        </div>
                                        <div class="col-lg-8">
                                            <input type="date" class="form-control" name="ten_date" id="ten_date" style="width: 178px;" placeholder="10 Kg">
                                        </div>
                                    </div>
                                </div>
                            </div>
