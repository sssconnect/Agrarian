...
<html lang="en">
    ...
    <head>
        ...
        <title>Wheat Harvesting Details</title>
        ...
        <nav class="navbar navbar-default" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">Agrarian Development</a>
                </div>
            ...
            <div class="row">
                <div class="box">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>Wheat Harvesting Details</strong>
                    </h2>
                    <hr>
