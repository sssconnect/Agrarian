...
<sql:query dataSource="${snapshot}" var="maize">
    SELECT * FROM maize_sowing_table where id=1;
</sql:query>
...
<head>
    <script >
            function setValue()
            {
               <c:forEach var="row" items="${maize.rows}">                               
        ...
        <div class="box">
			<hr>
				<h2 class="intro-text text-center">
							<strong>Maize Harvesting</strong>
				</h2>
			<hr>
            <img src="images/Maize-harvesting.JPG" height=400 weidth=600 >
			
			<div class="container-fluid" style="margin-top:1%">        
                <form method="post" action="MaizeHarvesting" class="form-inline">
