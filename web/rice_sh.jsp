            ...
            <div class="row">
                <div class="box">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>Rice Sowing</strong>
                    </h2>
                    <hr>
                    <img src="images/rice-sowing.jpg" height=400 weidth=600 >

                    <div class="container-fluid" style="margin-top:1%">        
                        <form method="post" action="RiceEntryController" class="form-inline">
