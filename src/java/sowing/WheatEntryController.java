 ...
 * @author com
 */
@WebServlet(name = "WheatEntryController", urlPatterns = {"/WheatEntryController"})
public class WheatEntryController extends HttpServlet {
    public int result=0;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            boolean status = dao.saveWheat(vo);
            
            if(status == true){
                session.setAttribute("Message", "Successfully Saved");
                response.sendRedirect("wheat_sh.jsp");
            } else {
                response.sendRedirect("wheat_sh.jsp");
            }
