 ...
 * @author com
 */
@WebServlet(name = "RiceEntryController", urlPatterns = {"/RiceEntryController"})
public class RiceEntryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            boolean status = dao.saveRice(vo);
            
            if(status == true){
                session.setAttribute("Message", "Successfully Saved");
                response.sendRedirect("rice_sh.jsp");
            } else {
                response.sendRedirect("rice_sh.jsp");
            }
