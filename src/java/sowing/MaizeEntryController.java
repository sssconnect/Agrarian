 ...
 */
@WebServlet(name = "MaizeEntryController", urlPatterns = {"/MaizeEntryController"})
public class MaizeEntryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            boolean status = dao.saveMaize(vo);
            
            if(status == true){
                session.setAttribute("Message", "Successfully Saved");
                response.sendRedirect("maize_sh.jsp");
            } else {
                response.sendRedirect("maize_sh.jsp");
            }
