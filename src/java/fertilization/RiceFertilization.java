 ...
 */
@WebServlet(name = "RiceFertilization", urlPatterns = {"/RiceFertilization"})
public class RiceFertilization extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
                ...
                try (PrintWriter out = response.getWriter())
        {
            ...
            boolean status = dao.saveRiceFertilization(vo);
            
            HttpSession session=request.getSession();
            if(status == true){
                session.setAttribute("Message", "Successfully Saved");
                response.sendRedirect("fertilization_rice.jsp");
            } else {
                response.sendRedirect("fertilization_rice.jsp");
            }
