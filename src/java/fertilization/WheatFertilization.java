 ...
 */
@WebServlet(name = "WheatFertilization", urlPatterns = {"/WheatFertilization"})
public class WheatFertilization extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            String Name = request.getParameter("harvest_name");
            ...
            boolean status = dao.saveWheatFertilization(vo);
            
            HttpSession session=request.getSession();
            if(status == true){
                session.setAttribute("Message", "Successfully Saved");
                response.sendRedirect("fertilization_wheat.jsp");
            } else {
                response.sendRedirect("fertilization_wheat.jsp");
            }
