...
<html lang="en">
    ...
    <head>
        ...
        <title>Maize Sowing Details</title>
            ...
            <div class="row">
                <div class="box">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>Maize Sowing Details</strong>
                    </h2>
                    <hr>
                    ...
                    <sql:query dataSource="${snapshot}" var="result">
                        SELECT * from maize_sowing_table;
                    </sql:query>
                    ...
                    <table border="1" width="100%">
                        ...
                        <c:forEach var="row" items="${result.rows}">
                            <tr>
                                ...
                                <td><c:out value="${row.ten_date}"/></td>
                                <td><c:out value="${row.cur_date}"/></td>
                            </tr>
                        </c:forEach>
                    </table>
