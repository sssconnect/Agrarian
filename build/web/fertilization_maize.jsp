...
<html lang="en">
    ...
    <head>
        ...
        <title>Maize Fertilization</title>
            ...
            <div class="row">
                <div class="box">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>Maize Fertilization</strong>
                    </h2>
                    <hr>
                    <img src="images/maize_fertilization.png" height=400 weidth=600 >

                    <div class="container-fluid" style="margin-top:1%">        
                        <form method="post" action="MaizeFertilization" class="form-inline">
