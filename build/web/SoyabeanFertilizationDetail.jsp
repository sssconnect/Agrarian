...
<html lang="en">
    ...
    <head>
        ...
        <title>Soyabean Fertilization Details</title>
            ...
            <div class="row">
                <div class="box">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>Soyabean Fertilization Details</strong>
                    </h2>
                    <hr>
                    ...
                    <sql:query dataSource="${snapshot}" var="result">
                        SELECT * from soya_fertilization;
                    </sql:query>
                    ...
                    <table border="1" width="100%">
                        ...
                        <c:forEach var="row" items="${result.rows}">
                            <tr>
                                ...
                                <td><c:out value="${row.weed_killer}"/></td>
                                <td><c:out value="${row.wdklr_quantity}"/></td>
                                <td><c:out value="${row.pesticides}"/></td>
                                <td><c:out value="${row.pesti_quantity}"/></td>
                                <td><c:out value="${row.tonic}"/></td>
                                <td><c:out value="${row.tonic_quantity}"/></td>
