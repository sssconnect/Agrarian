...
<html lang="en">
    ...
    <head>
        ...
        <title>Wheat Fertilization</title>
            ...
            <div class="row">
                <div class="box">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>Wheat Fertilization</strong>
                    </h2>
                    <hr>
                    <img src="images/wheat-fertilizer.jpg" height=400 weidth=600 >

                    <div class="container-fluid" style="margin-top:1%">        
                        <form method="post" action="WheatFertilization" class="form-inline">
