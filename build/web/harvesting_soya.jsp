...
<sql:query dataSource="${snapshot}" var="soya">
    SELECT * FROM soyabean_sowing_table ;
</sql:query>
-->
<html lang="en">
...
<head>
    ...
    <title>Soyabean Harvesting</title>
    ...
    <script >
            ...
            function reSet()
            {
                    ...
                    document.getElementById("harvest_name").setAttribute("value","");
                     document.getElementById("area").setAttribute("value","");
                      document.getElementById("ten_date").setAttribute("value","");
        ...
        <div class="box">
			<hr>
				<h2 class="intro-text text-center">
							<strong>Soyabean Harvesting</strong>
				</h2>
			<hr>
            <img src="images/soya-harvest.jpg" height=400 weidth=600 >
			
			<div class="container-fluid" style="margin-top:1%">        
                <form method="post" action="SoyabeanHarvesting" class="form-inline">
                    ...
                    <div class="col-lg-5">
                                <div class="form-group">
                                    <div class="row" >
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" class="form-control" name="harvest_name" id="harvest_name" style="width: 178px;" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <div class="row" >
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" name="area" id="area" style="width: 178px;" placeholder="10 Kg">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <input type="text" class="form-control" name="ten_date" id="ten_date" style="width: 178px;" placeholder="10 Kg">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button type="reset" onclick="reSet();" class="btn btn-primary" style="width:  100px;margin-top: 2% ">Clear</button>
		</form>						
</div>
</div>	
</div>
